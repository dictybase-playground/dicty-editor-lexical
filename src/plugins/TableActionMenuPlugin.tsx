...
const TableCellActionMenuContainer = (): JSX.Element => {
  const [editor] = useLexicalComposerContext()

  const menuButtonReference = useRef(null)
  const menuRootReference = useRef(null)
  ...
  const moveMenu = useCallback(() => {
    const menu = menuButtonReference.current
    const selection = $getSelection()
  ...
  useEffect(() => {
    const menuButtonDOM =
      menuButtonReference.current as HTMLButtonElement | null
  ...
  }, [menuButtonReference, tableCellNode, editor])
